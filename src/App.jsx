...
export default function App() {
  ...
  const [currentStyle, setCurrentStyle] = useState('swiss'); // swiss, vinyl, ticket, cyberpunk

  // Al seleccionar un álbum de la búsqueda, obtenemos su tracklist completo
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col md:flex-row">
      {/* Panel Izquierdo: Controles de Búsqueda y Estilos */}
      ...
      {/* Panel Derecho: Previsualización del Poster */}
